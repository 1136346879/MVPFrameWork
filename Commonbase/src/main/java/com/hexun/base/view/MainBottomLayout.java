...
public class MainBottomLayout extends LinearLayout {
    ...
    @BindColor(R2.color.bottomMenuOnTextColor)
    int bottomMenuOnTextColor;
    @BindColor(R2.color.bottomMenuTextColor)
    int bottomMenuTextColor;
    ...
    private void checkSelected(ImageView imageView, TextView textView) {
        if (imageView.isSelected()) {
            ...
            textView.setTextColor(bottomMenuOnTextColor);
        }
    }

    private void clearSelected(ImageView imageView, TextView textView) {
        imageView.setSelected(false);
        textView.setTextColor(bottomMenuTextColor);
    }
}
